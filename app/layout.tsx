...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "data:image/svg+xml,%3Csvg width='15' height='15' viewBox='0 0 15 15' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0H5V5H0V0Z' fill='%2314161F'/%3E%3Cpath d='M5 5H10V10H5V5Z' fill='%2314161F'/%3E%3Cpath d='M10 0H15V5H10V0Z' fill='%2314161F'/%3E%3Cpath d='M10 10H15V15H10V10Z' fill='%2314161F'/%3E%3Cpath d='M0 10L5 5V10H6.85185L5 11.7593V15H0V10Z' fill='%2314161F'/%3E%3C/svg%3E",
  },
}
