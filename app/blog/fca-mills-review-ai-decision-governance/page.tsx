...
export default function MillsReviewPost() {
  return (
    <main>
      <PageHeader
        eyebrow="Regulatory"
        head="The FCA Mills Review and What It Means for"
        tail="AI Decision Governance"
      />
        ...
        <div className="container">
          <div className="grid12">
            <div className="prose reveal">
              <div className="mono-caption" style={{ marginBottom: '40px' }}>
                MSDK Labs &nbsp;·&nbsp; 6 April 2026
              </div>
              ...
              <div style={{ marginTop: '56px', paddingTop: '40px', borderTop: '1px solid var(--rule)' }}>
                <h2 style={{ marginTop: 0 }}>Prepare for the regulatory direction.</h2>
                <p>Request early access to Aegis Trace and technical documentation.</p>
                <Link href="/#request-access" className="btn btn--on-light" style={{ marginTop: '8px' }}>Request Access</Link>
              </div>

              <div style={{ marginTop: '48px' }}>
                <Link href="/blog/" className="link-arrow" style={{ borderBottom: 'none' }}>&larr; Back to Insights</Link>
              </div>
            </div>
          </div>
        </div>
